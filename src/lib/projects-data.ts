export const allProjects = [
  {
    ...
    title: "Verdant Wellness — Brand Overhaul",
    client: "Verdant Wellness",
  ...
  },
  {
    ...
    tags: ["Paid Media", "Creative Direction", "Launch"],
    result: "₹2Cr revenue in 30 days",
    year: "2024",
    description:
  ...
  {
    slug: "artisan-co",
    title: "Artisan & Co. — E-Commerce",
    client: "Artisan & Co.",
    category: "Web Dev + Performance",
    tags: ["Shopify", "SEO", "Analytics", "Paid Media"],
    result: "4.2× ROAS improvement",
    year: "2023",
    description:
  ...
  {
    slug: "horizon-fin",
    title: "Horizon Finance — Content Strategy",
  ...
  {
    slug: "bloom-beauty",
    title: "Bloom Beauty — Brand Launch",
    client: "Bloom Beauty",
    category: "Brand Strategy + Content",
    tags: ["Branding", "Content", "Social Media"],
    result: "50K Instagram followers in 3 months",
    year: "2024",
    description:
