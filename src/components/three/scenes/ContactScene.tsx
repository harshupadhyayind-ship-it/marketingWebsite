...
export default function ContactScene() {
  ...
  return (
    <group ref={groupRef} position={[0, 0, -100]}>
      {/* Portal rings */}
      <PortalRing radius={3} tubeRadius={0.03} color="#9CAF88" speed={0.12} rotOffset={0} />
      <PortalRing radius={4} tubeRadius={0.025} color="#B8C9A8" speed={-0.08} rotOffset={1} />
      <PortalRing radius={5} tubeRadius={0.02} color="#D4CAB8" speed={0.06} rotOffset={2.1} />
      <PortalRing radius={2} tubeRadius={0.04} color="#9CAF88" speed={-0.18} rotOffset={0.5} />
      ...
      <Float speed={1} floatIntensity={1}>
        <Sphere args={[0.2, 16, 16]} position={[3.5, 1, 0.5]}>
          <meshStandardMaterial color="#B8C9A8" emissive="#B8C9A8" emissiveIntensity={0.8} />
        </Sphere>
      </Float>
      <Float speed={0.8} floatIntensity={0.8}>
        <Sphere args={[0.15, 16, 16]} position={[-3, -1.5, 0.3]}>
          <meshStandardMaterial color="#9CAF88" emissive="#9CAF88" emissiveIntensity={0.8} />
        </Sphere>
      </Float>
      ...
      <pointLight position={[0, 0, 3]} intensity={4} color="#9CAF88" distance={20} />
      <pointLight position={[0, 5, 0]} intensity={2} color="#F5F1E8" distance={15} />
    </group>
  );
}
