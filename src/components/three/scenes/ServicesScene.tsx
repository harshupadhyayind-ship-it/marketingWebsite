    ...
    <group ref={groupRef} position={[0, 0, -50]}>
      ...
      <Float speed={0.4} floatIntensity={0.3}>
        <Torus args={[2, 0.03, 16, 100]} position={[0, 0, 0]} rotation={[Math.PI / 2, 0, 0]}>
          <meshStandardMaterial color="#D64545" roughness={0} metalness={1} emissive="#D64545" emissiveIntensity={0.5} transparent opacity={0.6} />
        </Torus>
      </Float>

      <pointLight position={[0, 5, 3]} intensity={3} color="#D64545" distance={18} />
      <pointLight position={[0, -5, 3]} intensity={2} color="#E05555" distance={15} />
